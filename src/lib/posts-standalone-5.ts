...
export const BLOCKS_STANDALONE_5: Record<string, Block[]> = {
  'everybody-needs-a-coach': [
    ...
    { tag: 'p', text: 'A couple of years ago, he called me again. He was bringing his <a href="https://msb.georgetown.edu/mba/" target="_blank" rel="noopener noreferrer">Georgetown Executive MBA</a> students to Vietnam, and he wanted me to speak to them about negotiating internationally as an expat in Asia. I brought in my friend Dao Nguyen, and the three of us taught the cohort together.' },
    { tag: 'image', src: '/blog/images/dr-holtom-dave-dao.webp', alt: 'Dr Holtom, Dave, and Dao Nguyen at the front of the class with the Georgetown EMBA students', caption: 'With Dao and Dr Holtom at the front of the class with the Georgetown EMBA cohort in Saigon.' },
    { tag: 'p', text: 'Later that visit, Dr Holtom and I sat down for dinner at <a href="https://solkitchenbar.com/" target="_blank" rel="noopener noreferrer">SOL Kitchen</a>. The plates came and went and we kept talking. At some point I asked him a question.' },
