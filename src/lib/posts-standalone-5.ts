...
export const BLOCKS_STANDALONE_5: Record<string, Block[]> = {
  'everybody-needs-a-coach': [
    ...
    { tag: 'p', text: "In the late 1990s I was an undergrad at the University of Washington. I took a negotiations class from a PhD student named Dr Holtom. I did not know it at the time, but he would coach me, in different forms, for the next three decades." },
    { tag: 'p', text: "A few years after graduating, I looked him up. He had moved to Georgetown, the same campus where my father had done his PhD coursework. My dad and I made a trip out to DC together to visit him. We had coffee. He asked me what I was working on. He listened." },
    ...
    { tag: 'p', text: 'A couple of years ago, he called me again. He was bringing his Georgetown Executive MBA students to Vietnam, and he wanted me to speak to them about negotiating internationally as an expat in Asia. We had coffee in Saigon. I asked him a question.' },
    ...
    { tag: 'p', text: 'Rich Pham, Harley Trung, and Ray Chou sat through the rough versions of this program. Each one of them gave me notes I did not want to hear. Each one of them made it better. The polish that lets me deliver this work to senior executives did not come from one room. It came from many rooms, with patient friends willing to sit through the version that was not yet good.' },
    { tag: 'p', text: 'Dao Nguyen, regularly recognised as one of the top 50 lawyers in Asia, co-taught the Vietnam negotiations session with me when I knew I was not the right person to teach it alone. She did not have to. She did anyway. She coached me through it in real time, in front of a room of Georgetown EMBA students. That is a kind of coaching most people never see, because it happens at the front of a room.' },
    ...
    { tag: 'p', text: 'Janki, the President of EO Perth, showed me what was possible by building her own AI program before I had the courage to build mine. Nhan, the President of EO Vietnam, helped pilot <em>Leadership in the AI Era</em> in my home chapter when it was still rough. They coach me on what to do next, and what not to do, every time we talk.' },
